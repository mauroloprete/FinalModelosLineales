...
Contamos una tabla de datos, con una observación por cada estado y 16 variables (una de ellas la tasa de criminalidad). 

Se construye un modelo :

- Asumiendo relación lineal entre las variables independientes y dependientes (Todo cambio en $X$ en una misma unidad tiene el mismo impacto en $y$) 
...
.center[
<h3>
A lo largo de esta presentación se mostrara si esto es válido para nuestro ejemplo o bajo que condiciones lo hacen.
</h3>
]
---
