...
Para poder afirmar que se cumple el supuesto de normalidad de los errores relizaremos, tres pruebas:
...
En base a los test se puede afirmar que la distribución de los errores sigue una distribución Normal, a continuación haremos el analisis de la homocedasticidad.
