...
En esta gráfica se puede ver la correlación entre las variables presentadas y un gráfico de dispersión y la distribución de la variable.
...
el archivo \textbf{USCrime.txt}, en el proceso se desplegaran las diferentes gráficas y tablas, así como el modelo completo \textit{ModeloCompleto}
