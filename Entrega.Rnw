...
que continuaremos con la selección a pasos por el método Stepwise.
...
cercana a cero, a diferencia de algunas observaciones, a su vez , no encontramos un patrón en la dispersión de los errores,
...
a exepción de la observación 46,11 y 6.
...
En base a los test puedo afirtmar que la distribución de los errores es normal.
