...
<<out.width = "1\\textwidth",fig.align = "center",fig.cap = "Mapa de correlación de variables incluidas",out.width = "0.5\\textwidth",fig.align = "center">>=
qplot(x=Var1,
      y=Var2,
...
\section{Especificación y selección de modelos inicial}
