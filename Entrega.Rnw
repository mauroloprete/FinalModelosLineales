...
Para detectar observatios atípicas, se construye un vector con los residuos studentisados del modelo y se compara con el umbral definido por
...
\textbf{11} son influyentes y atipicas, mientras que para la número \textbf{18} podemos ver que es muy cercana a cero, la esperanza de los errores por lo que es solamente atipica.
...
Uno de los supuestos fundamentales al momento de construír este modelo lineal, refiere a la distribución de los errores, en este caso siguen una distribución normal.
