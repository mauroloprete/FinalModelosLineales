...
## ----fig.align= "center",out.width = "0.8\\textwidth",fig.cap = "Distancia de Cook Modelo reducido"----
...
## ----fig.align= "center",out.width = "0.8\\textwidth",fig.cap = "Análisis de observaciones atípicas"----
...
## ----out.width = "0.65\\textwidth",fig.align = "center",fig.cap = "Normalidad: Residuos vs modelo y Normal QQ-Plot"----
...
## ----out.width = "0.5\\textwidth",fig.align = "center",fig.cap = "Distribución normal y distribución errores (Suavizada distribución Kernel)"----
...
ModeloRedInter %>% 
  ...
  kbl(
    booktabs = T, 
    caption = "Test de Normalidad $\\alpha = 0.05$",
    escape = FALSE,
    row.names = FALSE
  ) %>% 
  kable_styling(
